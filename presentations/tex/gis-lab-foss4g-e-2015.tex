...
%\TODO: gislab architecture - clients communication each other 
...
\begin{frame}{The Cow}
	\textbf{3 years} old, \textbf{30 litres} of milk for \textbf{20 kg} of GRASS daily
	\begin{center}
...
\begin{frame}{The Idea}
	\begin{center}
		Is there any chance to have a system which is working \textbf{out-of-box ?}
	\end{center}
\end{frame}
