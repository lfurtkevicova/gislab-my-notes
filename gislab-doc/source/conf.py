...
exclude_patterns = ['../output', "../resources", "../scripts"]
...
rst_prolog = """
.. role:: disclaimer
.. |updatedisclaimer| replace:: :disclaimer:`Documentation for development version of GIS.lab.`
"""
...
latex_documents = [
    ('docs/client_environment/index', 'GISlab-client-environment.tex', u'GIS.lab client environment', u'GIS.lab Project', 'manual')
]
