# -*- coding: utf-8 -*-
#
# GIS.lab documentation build configuration file, created by
...
#  others: nature, default, sphinxdoc, traditional, ... 
...
latex_documents = [
  ('index', 'GISlab.tex', u'GIS.lab Documentation',
